...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeamAssessmentCluster'
        db.create_table(u'assessment_teamassessmentcluster', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'assessment', ['TeamAssessmentCluster'])

        # Adding M2M table for field bands on 'TeamAssessmentCluster'
        m2m_table_name = db.shorten_name(u'assessment_teamassessmentcluster_bands')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('teamassessmentcluster', models.ForeignKey(orm[u'assessment.teamassessmentcluster'], null=False)),
            ('assessmentband', models.ForeignKey(orm[u'assessment.assessmentband'], null=False))
        ))
        db.create_unique(m2m_table_name, ['teamassessmentcluster_id', 'assessmentband_id'])


    def backwards(self, orm):
        # Deleting model 'TeamAssessmentCluster'
        db.delete_table(u'assessment_teamassessmentcluster')

        # Removing M2M table for field bands on 'TeamAssessmentCluster'
        db.delete_table(db.shorten_name(u'assessment_teamassessmentcluster_bands'))
