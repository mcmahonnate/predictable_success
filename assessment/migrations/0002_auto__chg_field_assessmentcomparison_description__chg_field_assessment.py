...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssessmentComparison.description'
        db.alter_column(u'assessment_assessmentcomparison', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'AssessmentBand.description'
        db.alter_column(u'assessment_assessmentband', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'AssessmentComparison.description'
        db.alter_column(u'assessment_assessmentcomparison', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AssessmentBand.description'
        db.alter_column(u'assessment_assessmentband', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
