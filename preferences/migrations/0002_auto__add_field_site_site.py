...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.site'
        db.add_column(u'preferences_site', 'site',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True, null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.site'
        db.delete_column(u'preferences_site', 'site_id')
