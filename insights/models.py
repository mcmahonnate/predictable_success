...
class Prospect(models.Model):
    ...
    @property
    def talent_category_description(self):
        if self.talent_category:
            return dict(self.TALENT_CATEGORY_CHOICES).get(self.talent_category)
        return None

    @property
    def engagement_description(self):
        if self.engagement:
            return dict(self.ENGAGEMENT_CHOICES).get(self.engagement)
        return None
