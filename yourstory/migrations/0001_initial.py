    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a13', models.ForeignKey(related_name='+', to='yourstory.TextResponse', null=True)),
                ('a14', models.ForeignKey(related_name='+', to='yourstory.EmployeeChoiceResponse', null=True)),
                ...
                ('a21', models.ForeignKey(related_name='+', to='yourstory.TextResponse', null=True)),
                ('a22', models.ForeignKey(related_name='+', to='yourstory.EmployeeChoiceResponse', null=True)),
                ...
                ('a9', models.ForeignKey(related_name='+', to='yourstory.TextResponse', null=True)),
