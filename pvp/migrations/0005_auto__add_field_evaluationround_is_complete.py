...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EvaluationRound.is_complete'
        db.add_column(u'pvp_evaluationround', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EvaluationRound.is_complete'
        db.delete_column(u'pvp_evaluationround', 'is_complete')
