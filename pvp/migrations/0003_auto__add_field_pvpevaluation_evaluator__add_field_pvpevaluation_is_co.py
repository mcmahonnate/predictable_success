...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PvpEvaluation.evaluator'
        db.add_column(u'pvp_pvpevaluation', 'evaluator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PvpEvaluation.is_complete'
        db.add_column(u'pvp_pvpevaluation', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PvpEvaluation.evaluator'
        db.delete_column(u'pvp_pvpevaluation', 'evaluator_id')

        # Deleting field 'PvpEvaluation.is_complete'
        db.delete_column(u'pvp_pvpevaluation', 'is_complete')
    ...
    models = {
        ...
        u'pvp.pvpevaluationassignment': {
            ...
            'evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pvp.PvpEvaluation']", 'null': 'True', 'blank': 'True'}),
            'evaluation_round': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pvp.EvaluationRound']"}),
