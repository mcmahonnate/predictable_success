...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Happiness'
        db.create_table(u'engagement_happiness', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assessed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['org.Employee'])),
        ...
        db.send_create_signal(u'engagement', ['Happiness'])


    def backwards(self, orm):
        # Deleting model 'Happiness'
        db.delete_table(u'engagement_happiness')
    ...
    models = {
        ...
        u'engagement.happiness': {
            'Meta': {'object_name': 'Happiness'},
            'assessed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['org.Employee']"}),
