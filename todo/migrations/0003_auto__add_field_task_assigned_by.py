...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.assigned_by'
        db.add_column(u'todo_task', 'assigned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['org.Employee']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.assigned_by'
        db.delete_column(u'todo_task', 'assigned_by_id')
    ...
    models = {
        ...
        u'todo.task': {
            ...
            'assigned_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['org.Employee']"}),
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['org.Employee']"}),
            'completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['org.Employee']"}),
