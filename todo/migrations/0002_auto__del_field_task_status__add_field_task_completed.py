...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'todo_task', 'status')

        # Adding field 'Task.completed'
        db.add_column(u'todo_task', 'completed',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'todo_task', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unassigned', max_length=10),
                      keep_default=False)

        # Deleting field 'Task.completed'
        db.delete_column(u'todo_task', 'completed')
