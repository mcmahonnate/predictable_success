...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'todo_task', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['org.Employee'])),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['org.Employee'])),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='unassigned', max_length=10)),
        ))
    ...
    models = {
        ...
        u'todo.task': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['org.Employee']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'unassigned'", 'max_length': '10'})
        }
    }
