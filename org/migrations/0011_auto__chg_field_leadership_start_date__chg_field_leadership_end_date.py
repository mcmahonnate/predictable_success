...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Leadership.start_date'
        db.alter_column(u'org_leadership', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Leadership.end_date'
        db.alter_column(u'org_leadership', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Leadership.start_date'
        db.alter_column(u'org_leadership', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Leadership.end_date'
        db.alter_column(u'org_leadership', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
