...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employee.coach'
        db.alter_column(u'org_employee', 'coach_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['org.Employee']))

    def backwards(self, orm):

        # Changing field 'Employee.coach'
        db.alter_column(u'org_employee', 'coach_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
