...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.departure_date'
        db.add_column(u'org_employee', 'departure_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.departure_date'
        db.delete_column(u'org_employee', 'departure_date')
