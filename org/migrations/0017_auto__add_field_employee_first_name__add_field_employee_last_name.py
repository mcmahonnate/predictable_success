...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'org_employee', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.last_name'
        db.add_column(u'org_employee', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'org_employee', 'first_name')

        # Deleting field 'Employee.last_name'
        db.delete_column(u'org_employee', 'last_name')
