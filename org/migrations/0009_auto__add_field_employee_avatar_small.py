...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.avatar_small'
        db.add_column(u'org_employee', 'avatar_small',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.avatar_small'
        db.delete_column(u'org_employee', 'avatar_small')
