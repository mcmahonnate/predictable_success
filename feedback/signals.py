...
from .models import FeedbackRequest, FeedbackHelpful
from .tasks import send_coach_coachee_requested_feedback_slack, send_helpful_slack
...
@receiver(post_save, sender=FeedbackHelpful)
def helpful_save_handler(sender, instance, created, **kwargs):
    if created:
        send_helpful_slack.subtask((instance.id,)).apply_async()
