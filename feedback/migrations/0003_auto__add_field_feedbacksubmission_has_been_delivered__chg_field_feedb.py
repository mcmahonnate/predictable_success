...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackSubmission.has_been_delivered'
        db.add_column(u'feedback_feedbacksubmission', 'has_been_delivered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'FeedbackSubmission.feedback_date'
        db.alter_column(u'feedback_feedbacksubmission', 'feedback_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'FeedbackSubmission.has_been_delivered'
        db.delete_column(u'feedback_feedbacksubmission', 'has_been_delivered')


        # Changing field 'FeedbackSubmission.feedback_date'
        db.alter_column(u'feedback_feedbacksubmission', 'feedback_date', self.gf('django.db.models.fields.DateTimeField')())
