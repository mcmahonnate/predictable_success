...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedbackRequest.response'
        db.delete_column(u'feedback_feedbackrequest', 'response_id')


        # Changing field 'FeedbackRequest.request_date'
        db.alter_column(u'feedback_feedbackrequest', 'request_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'FeedbackSubmission.feedback_request'
        db.add_column(u'feedback_feedbacksubmission', 'feedback_request',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='submissions', null=True, to=orm['feedback.FeedbackRequest']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FeedbackRequest.response'
        db.add_column(u'feedback_feedbackrequest', 'response',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.FeedbackSubmission'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'FeedbackRequest.request_date'
        db.alter_column(u'feedback_feedbackrequest', 'request_date', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'FeedbackSubmission.feedback_request'
        db.delete_column(u'feedback_feedbacksubmission', 'feedback_request_id')
