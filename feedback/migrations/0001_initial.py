...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feedback_feedbackrequest', (
            ...
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_requests', to=orm['org.Employee'])),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requests_for_feedback', to=orm['org.Employee'])),
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.FeedbackSubmission'], null=True, blank=True)),
            ('is_complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'feedback', ['FeedbackRequest'])

        # Adding model 'FeedbackSubmission'
        db.create_table(u'feedback_feedbacksubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feedback_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_about', to=orm['org.Employee'])),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_submissions', to=orm['org.Employee'])),
            ('excels_at', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('could_improve_on', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'feedback', ['FeedbackSubmission'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeedbackSubmission'
        db.delete_table(u'feedback_feedbacksubmission')
    ...
    models = {
        ...
        u'feedback.feedbackrequest': {
            ...
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['feedback.FeedbackSubmission']", 'null': 'True', 'blank': 'True'}),
        ...
        u'feedback.feedbacksubmission': {
            ...
            'feedback_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
