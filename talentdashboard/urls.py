...
urlpatterns = patterns('',
    ...
    url(r'api/v1/coaches/$', (cache_on_auth(60*15, 'foolsquad','Coach')(CoachList.as_view())), name='coach-list'),
    ...
    url(r'api/v1/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(EmployeeDetail.as_view())), name='employee-detail'),
    ...
    url(r'api/v1/engagement/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(EmployeeEngagement.as_view()))),
    url(r'api/v1/assessment/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(Assessment.as_view()))),
    url(r'api/v1/assessment/mbti/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(EmployeeMBTI.as_view()))),
    ...
    url(r'api/v1/comments/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(EmployeeCommentList.as_view()))),
    ...
    url(r'api/v1/comments/subcomments/(?P<pk>.*)', (group_required('foolsquad','Coach')(SubCommentList.as_view()))),
    url(r'api/v1/comments/$', (group_required('foolsquad','Coach')(CommentList.as_view()))),
    url(r'api/v1/comments/(?P<pk>.*)', (group_required('foolsquad','Coach')(CommentDetail.as_view()))),
    url(r'api/v1/tasks/employees/(?P<pk>.*)', (group_required('foolsquad','Coach')(EmployeeTaskList.as_view()))),
    url(r'api/v1/tasks/$', (MyTaskList.as_view())),
    url(r'api/v1/tasks/(?P<pk>.*)', (group_required('foolsquad','Coach')(TaskDetail.as_view()))),
