...
urlpatterns = patterns('',
    ...
    url(r'api/v1/employees/$', (cache_on_auth(60*15, ['foolsquad']))(EmployeeList.as_view()), name='employee-list'),
    url(r'api/v1/employees/(?P<pk>.*)', (cache_on_auth(60*15, ['foolsquad']))(EmployeeDetail.as_view()), name='employee-detail'),
    ...
    url(r'api/v1/talent-category-reports/teams/(?P<pk>.*)', (cache_on_auth(60*15, ['foolsquad']))(TeamTalentCategoryReportDetail.as_view())),
    url(r'api/v1/talent-category-reports/(?P<pk>.*)', (cache_on_auth(60*15, ['foolsquad']))(TalentCategoryReportDetail.as_view())),
    url(r'api/v1/salary-reports/teams/(?P<pk>.*)', (cache_on_auth(60*15, ['foolsquad']))(TeamSalaryReportDetail.as_view())),
    url(r'api/v1/salary-reports/company/', (cache_on_auth(60*15, ['foolsquad']))(get_company_salary_report)),
