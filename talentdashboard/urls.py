...
urlpatterns = patterns('',
    ...
    url(r'api/v1/comments/$', (auth_employee('AllAccess','CoachAccess')(CommentList.as_view()))),
    url(r'api/v1/comments/(?P<pk>.*)', (auth_employee('AllAccess','CoachAccess')(CommentDetail.as_view()))),
