...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/talent-category-reports/coach/(?P<pk>[0-9]+)/$', (auth_employee('AllAccess','CoachAccess')(CoachTalentCategoryReportDetail.as_view()))),
    ...
    url(r'^api/v1/comments/coaches/(?P<pk>[0-9]+)/$', (auth_employee('AllAccess','CoachAccess')(CoachCommentList.as_view()))),
