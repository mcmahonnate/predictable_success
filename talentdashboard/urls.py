...
urlpatterns = patterns('',
    ...
    url(r'api/v1/coaches/$', (cache_on_auth(60*15, 'foolsquad','Coaches')(CoachList.as_view())), name='coach-list'),
    ...
    url(r'api/v1/employees/(?P<pk>.*)', (group_required('foolsquad','Coaches')(EmployeeDetail.as_view())), name='employee-detail'),
    ...
    url(r'api/v1/engagement/employees/(?P<pk>.*)', (group_required('foolsquad','Coaches')(EmployeeEngagement.as_view()))),
    url(r'api/v1/assessment/employees/(?P<pk>.*)', (group_required('foolsquad','Coaches')(Assessment.as_view()))),
    ...
    url(r'api/v1/talent-category-reports/lead/(?P<pk>.*)', (cache_on_auth(60*15, 'foolsquad'))(group_required('foolsquad')(LeadTalentCategoryReportDetail.as_view()))),
    ...
    url(r'api/v1/salary-reports/lead/(?P<pk>.*)', (cache_on_auth(60*15, 'foolsquad'))(group_required('foolsquad')(LeadSalaryReportDetail.as_view()))),
    url(r'api/v1/salary-reports/company/', get_company_salary_report),
    url(r'api/v1/comments/employees/(?P<pk>.*)', (group_required('foolsquad','Coaches')(EmployeeCommentList.as_view()))),
    url(r'api/v1/comments/teams/(?P<pk>.*)', (group_required('foolsquad')(TeamCommentList.as_view()))),
    url(r'api/v1/comments/leads/(?P<pk>.*)', (group_required('foolsquad')(LeadCommentList.as_view()))),
    url(r'api/v1/comments/subcomments/(?P<pk>.*)', (group_required('foolsquad','Coaches')(SubCommentList.as_view()))),
    url(r'api/v1/comments/$', (group_required('foolsquad','Coaches')(CommentList.as_view()))),
    url(r'api/v1/comments/(?P<pk>.*)', (group_required('foolsquad','Coaches')(CommentDetail.as_view()))),
    url(r'api/v1/tasks/employees/(?P<pk>.*)', (group_required('foolsquad','Coaches')(EmployeeTaskList.as_view()))),
    url(r'api/v1/tasks/$', (MyTaskList.as_view())),
    url(r'api/v1/tasks/(?P<pk>.*)', (group_required('foolsquad','Coaches')(TaskDetail.as_view()))),
