...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/import-data/$', (auth_employee('AllAccess')(ImportData.as_view()))),
    ...
    url(r'^api/v1/engagement-survey/(?P<pk>[0-9]+)/(?P<sid>[0-9]+)/$', EngagementSurvey.as_view()),
    ...
    url(r'^api/v1/talent-category-reports/lead/(?P<pk>[0-9]+)/$', (auth_employee('AllAccess','TeamLeadAccess')(LeadTalentCategoryReportDetail.as_view()))),
    ...
    url(r'^api/v1/salary-reports/teams/(?P<pk>[0-9]+)/$', (auth_cache(60*15, 'AllAccess'))(auth('AllAccess')(TeamSalaryReportDetail.as_view()))),
    url(r'^api/v1/salary-reports/lead/(?P<pk>[0-9]+)/$', (auth_employee('AllAccess','TeamLeadAccess')(LeadSalaryReportDetail.as_view()))),
    ...
    url(r'^api/v1/comments/leads/(?P<pk>[0-9]+)/$', (auth_employee('AllAccess','TeamLeadAccess')(LeadCommentList.as_view()))),
