...
urlpatterns = patterns('',
    ...
    url(r'api/v1/talent-category-reports/coach/(?P<pk>.*)', (auth_employee('AllAccess','CoachAccess')(CoachTalentCategoryReportDetail.as_view()))),
    ...
    url(r'api/v1/comments/coaches/(?P<pk>.*)', (auth_employee('AllAccess','CoachAccess')(CoachCommentList.as_view()))),
