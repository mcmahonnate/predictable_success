angular.module('tdb.activity.services', ['ngResource'])
    ...
    .factory('Event', ['$resource', function($resource) {
        ...
        Event.getEmployeeEvents = function(id, page, type, success, failure) { return this.get({ path: 'employees', id: id, page: page, exclude_third_party_events: false, type: type}, success, failure); };
