var app = angular.module('tdb', [
    ...
    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.
          ...
          when('/employees/my-team', {templateUrl: '/static/angular/partials/evaluation-list.html', controller: 'MyTeamEvaluationListCtrl', resolve: {authorizeRoute: authorizeRoute}}).
          when('/employees/my-coachees', {templateUrl: '/static/angular/partials/evaluation-list.html', controller: 'MyCoacheesEvaluationListCtrl', resolve: {authorizeRoute: authorizeRoute}}).
          ...
          when('/employees', {templateUrl: '/static/angular/partials/employee-list.html', controller: 'EmployeeSearchCtrl', resolve: {authorizeRoute: authorizeRoute, factory: reRoute}}).
