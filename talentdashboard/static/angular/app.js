angular.module('tdb', ['tdb.services', 'tdb.controllers', 'tdb.directives', 'angular-carousel']).
  ...
  $routeProvider.
      ...
      when('/overview', {templateUrl: '/static/angular/partials/company-overview.html'}).
      when('/teams/:id/overview', {templateUrl: '/static/angular/partials/team-overview.html', controller: 'TeamOverviewCtrl'}).
