app.config(['$routeProvider', function($routeProvider) {
    $routeProvider.
      ...
      when('/leadership_style/request/:requestId/reply', {templateUrl: '/static/angular/leadership-style/partials/index.html', controller: 'LeadershipStyleController as index', resolve: {authorizeRoute: authorizeRoute}}).
