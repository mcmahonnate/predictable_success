app.config(['$routeProvider', function($routeProvider) {
    $routeProvider.
      ...
      when('/pvp/todo', {templateUrl: '/static/angular/pvp/partials/pvp-todo.html', controller: 'PvpEvaluationTodosCtrl', resolve: {authorizeRoute: authorizeRoute}}).
      ...
      when('/reports/feedback', {templateUrl: '/static/angular/feedback/partials/report.html', controller: 'FeedbackReportController as feedbackReport', resolve: {authorizeRoute: authorizeRoute}}).
      ...
      when('/reports/coaching', {templateUrl: '/static/angular/profile/partials/coach-report.html', controller: 'CoachReportController as coachReport', resolve: {authorizeRoute: authorizeRoute}}).
